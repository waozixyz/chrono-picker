...
export declare const isSelected: (props: any, state: any, day: number) => boolean;
export declare const isDateInRange: (props: any, state: any, date: DateTime) => boolean;
...
export declare const formatMonth: (props: any, state: any) => string;
