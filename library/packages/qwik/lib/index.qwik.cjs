...
const TimePicker = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesScopedQrl(/* @__PURE__ */ qwik.inlinedQrl(STYLES$2, "TimePicker_component_useStylesScoped_4onheJGjMFM"));
...
const Calendar = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik.useStylesScopedQrl(/* @__PURE__ */ qwik.inlinedQrl(STYLES$1, "Calendar_component_useStylesScoped_LsNl0Wgvea4"));
  const state = qwik.useStore({
    accentColor: props.accentColor || "#007bff",
    backgroundColor: props.backgroundColor || "#ffffff",
  ...
  return /* @__PURE__ */ qwik._jsxQ("div", {
    ...
    /* @__PURE__ */ qwik._jsxQ("div", null, {
      ...
      /* @__PURE__ */ qwik._jsxQ("span", null, null, formatMonth(props, state), 1, null),
      /* @__PURE__ */ qwik._jsxQ("button", {
        onClick$: /* @__PURE__ */ qwik.inlinedQrl((event) => {
          const [props2, state2] = qwik.useLexicalScope();
          return changeMonth(props2, state2, 1);
    ...
    /* @__PURE__ */ qwik._jsxQ("div", null, {
      ...
      (getEmptyCells(props, state) || []).map((_, i) => {
        return /* @__PURE__ */ qwik._jsxQ("div", null, null, null, 3, `empty-${i}`);
      }),
      (getDayCells(props, state) || []).map((_, i) => {
        return /* @__PURE__ */ qwik._jsxQ("div", {
          ...
          onClick$: /* @__PURE__ */ qwik.inlinedQrl((event) => {
            const [i2, props2, state2] = qwik.useLexicalScope();
...
const DateTimePicker = /* @__PURE__ */ qwik.componentQrl(/* @__PURE__ */ qwik.inlinedQrl((props) => {
  qwik._jsxBranch();
  qwik.useStylesScopedQrl(/* @__PURE__ */ qwik.inlinedQrl(STYLES, "DateTimePicker_component_useStylesScoped_8XKe06WrVaA"));
  const state = qwik.useStore({
    accentColor: props.accentColor || "#007bff",
    backgroundColor: props.backgroundColor || "#ffffff",
    borderStyle: props.showBorder ? `1px solid ${props.accentColor || "#007bff"}` : "none",
  ...
  return /* @__PURE__ */ qwik._jsxQ("div", {
    ...
    /* @__PURE__ */ qwik._jsxQ("div", null, {
      ...
      /* @__PURE__ */ qwik._jsxQ("span", null, null, formatDate(props, state), 1, null),
      /* @__PURE__ */ qwik._jsxQ("button", {
        onClick$: /* @__PURE__ */ qwik.inlinedQrl((event) => {
          const [props2, state2] = qwik.useLexicalScope();
        ...
        class: "toggle-button"
      }, state.isCalendarOpen ? /* @__PURE__ */ qwik._jsxC(jsxRuntime.Fragment, {
        children: "▲"
      }, 3, "qR_0") : /* @__PURE__ */ qwik._jsxC(jsxRuntime.Fragment, {
        children: "▼"
      }, 3, "qR_1"), 0, null)
    ], 1, null),
    state.isCalendarOpen ? /* @__PURE__ */ qwik._jsxC(Calendar, {
      get value() {
      ...
      [qwik._IMMUTABLE]: {
        accentColor: qwik._fnSignal((p0) => p0.accentColor, [
          state
        ], "p0.accentColor"),
        backgroundColor: qwik._fnSignal((p0) => p0.backgroundColor, [
          state
        ], "p0.backgroundColor"),
        fontSize: qwik._fnSignal((p0) => p0.fontSize, [
          state
        ], "p0.fontSize"),
        maxDate: qwik._fnSignal((p0) => p0.maxDate, [
          props
        ], "p0.maxDate"),
        minDate: qwik._fnSignal((p0) => p0.minDate, [
          props
        ], "p0.minDate"),
        textColor: qwik._fnSignal((p0) => p0.textColor, [
          state
        ], "p0.textColor"),
        value: qwik._fnSignal((p0) => p0.selectedDateTime, [
          state
        ], "p0.selectedDateTime")
      }
    }, 2, "qR_2") : null,
    /* @__PURE__ */ qwik._jsxC(TimePicker, {
      get value() {
        return state.selectedDateTime;
      },
      onChange$: /* @__PURE__ */ qwik.inlinedQrl((event) => {
      ...
      [qwik._IMMUTABLE]: {
        ...
        format: qwik._fnSignal((p0) => p0.format, [
          props
        ], "p0.format"),
        showBorder: qwik._IMMUTABLE,
        size: qwik._fnSignal((p0) => p0.size, [
          props
        ], "p0.size"),
        textColor: qwik._fnSignal((p0) => p0.textColor, [
          state
