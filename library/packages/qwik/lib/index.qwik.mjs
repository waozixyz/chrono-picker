import { componentQrl, inlinedQrl, useStylesScopedQrl, useStore, useVisibleTaskQrl, useLexicalScope, useTaskQrl, _jsxQ, _fnSignal, _jsxBranch, _jsxC, _IMMUTABLE } from "@builder.io/qwik";
...
const TimePicker = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesScopedQrl(/* @__PURE__ */ inlinedQrl(STYLES$2, "TimePicker_component_useStylesScoped_4onheJGjMFM"));
  ...
  }, "TimePicker_component_useVisibleTask_FomQZmxbtIo", [
    props,
    state
  ]));
  useTaskQrl(/* @__PURE__ */ inlinedQrl(({ track }) => {
    ...
    state2.minute = val.getMinutes();
    state2.period = val.getHours() >= 12 ? "PM" : "AM";
  }, "TimePicker_component_useTask_kq1ZCEcSco4", [
    props,
    state
  ]));
  return /* @__PURE__ */ _jsxQ("div", {
    ...
    /* @__PURE__ */ _jsxQ("button", {
      ...
      }, "TimePicker_component_div_button_onClick_pZ30mzDmf0g", [
        props,
        state
      ])
    }, {
    ...
    /* @__PURE__ */ _jsxQ("button", {
      ...
      }, "TimePicker_component_div_button_onClick_1_Djr0lgQoYVo", [
        props,
        state
      ])
    }, {
    ...
    /* @__PURE__ */ _jsxQ("input", {
      ...
      }, "TimePicker_component_div_input_onChange_eg7SmvHoIqk", [
        props,
        state
      ])
    }, {
    ...
    /* @__PURE__ */ _jsxQ("input", {
      ...
      }, "TimePicker_component_div_input_onChange_1_JZQJSaGTt7U", [
        props,
        state
      ])
    }, {
    ...
    /* @__PURE__ */ _jsxQ("button", {
      ...
      }, "TimePicker_component_div_button_onClick_2_rAanVG0lJnU", [
        props,
        state
      ])
    }, {
    ...
    /* @__PURE__ */ _jsxQ("button", {
      ...
      }, "TimePicker_component_div_button_onClick_3_e71aelBpcGo", [
        props,
        state
      ])
    }, {
    ...
    props.format === "12h" ? /* @__PURE__ */ _jsxQ("div", null, {
      ...
      /* @__PURE__ */ _jsxQ("button", {
        ...
        }, "TimePicker_component_div_div_button_onClick_aF8UlH7E9lA", [
          props,
          state
        ])
      }, {
      ...
      /* @__PURE__ */ _jsxQ("button", {
        onClick$: /* @__PURE__ */ inlinedQrl((event) => {
          const [props2, state2] = useLexicalScope();
          return togglePeriod(props2, state2);
        }, "TimePicker_component_div_div_button_onClick_1_lRPZfP7H28Y", [
          props,
          state
        ])
      }, {
...
}, "TimePicker_component_VeBJ8hYHSUM"));
const STYLES$2 = `
.time-picker {
...
const changeMonth = function changeMonth2(props, state, delta) {
  const currentMonth = DateTime.fromISO(state.currentMonthISO);
  state.currentMonthISO = currentMonth.plus({
    months: delta
  }).startOf("month").toISO() || "";
};
const selectDate = function selectDate2(props, state, day) {
  const currentMonth = DateTime.fromISO(state.currentMonthISO);
...
const getEmptyCells = function getEmptyCells2(props, state) {
  const currentMonth = DateTime.fromISO(state.currentMonthISO);
  return Array(currentMonth.isValid ? currentMonth.weekday % 7 : 0).fill(null);
};
const getDayCells = function getDayCells2(props, state) {
  const currentMonth = DateTime.fromISO(state.currentMonthISO);
  return Array(currentMonth.isValid ? currentMonth.daysInMonth : 0).fill(null);
};
const isSelected = function isSelected2(props, state, day) {
  const currentMonth = DateTime.fromISO(state.currentMonthISO);
  const selectedDate = DateTime.fromISO(state.selectedDateISO);
  return currentMonth.isValid && selectedDate.isValid && selectedDate.hasSame(currentMonth.set({
    day
  }), "day");
};
const isDateInRange = function isDateInRange2(props, state, date) {
...
const isDisabled = function isDisabled2(props, state, day) {
  const currentMonth = DateTime.fromISO(state.currentMonthISO);
  return !currentMonth.isValid || !isDateInRange(props, state, currentMonth.set({
    day
  }));
};
const getWeekdays = function getWeekdays2(props, state) {
  return Info.weekdays("short", {
    locale: state.locale
  });
};
const formatMonth = function formatMonth2(props, state) {
  const currentMonth = DateTime.fromISO(state.currentMonthISO);
  return currentMonth.isValid ? currentMonth.toLocaleString({
    month: "long",
    year: "numeric"
  }) : "";
};
const Calendar = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesScopedQrl(/* @__PURE__ */ inlinedQrl(STYLES$1, "Calendar_component_useStylesScoped_LsNl0Wgvea4"));
  const state = useStore({
    accentColor: props.accentColor || "#007bff",
    backgroundColor: props.backgroundColor || "#ffffff",
    ...
    maxDateISO: (props.maxDate ? DateTime.fromJSDate(props.maxDate) : DateTime.local().plus({
      years: 100
    })).toISO() || "",
    minDateISO: (props.minDate ? DateTime.fromJSDate(props.minDate) : DateTime.local().minus({
      years: 100
    })).toISO() || "",
  ...
  useVisibleTaskQrl(/* @__PURE__ */ inlinedQrl(() => {
    const [props2, state2] = useLexicalScope();
    const initialDate = props2.value ? DateTime.fromJSDate(props2.value) : DateTime.local();
    state2.currentMonthISO = initialDate.startOf("month").toISO() || "";
    state2.selectedDateISO = initialDate.toISO() || "";
  }, "Calendar_component_useVisibleTask_bhB4H3Iu6g8", [
    props,
    state
  ]));
  useTaskQrl(/* @__PURE__ */ inlinedQrl(({ track }) => {
    ...
    track(() => props2.value);
    if (props2.value) {
      const selectedDate = DateTime.fromJSDate(props2.value);
      if (selectedDate.isValid) {
        state2.selectedDateISO = selectedDate.toISO() || "";
        state2.currentMonthISO = selectedDate.startOf("month").toISO() || "";
      }
    }
  }, "Calendar_component_useTask_jar2OvJJCn8", [
    props,
    state
  ]));
  return /* @__PURE__ */ _jsxQ("div", {
    ...
    /* @__PURE__ */ _jsxQ("div", null, {
      ...
      /* @__PURE__ */ _jsxQ("button", {
        onClick$: /* @__PURE__ */ inlinedQrl((event) => {
          const [props2, state2] = useLexicalScope();
          return changeMonth(props2, state2, -1);
        }, "Calendar_component_div_div_button_onClick_MM6n0vinVCc", [
          props,
          state
        ])
      }, {
      ...
      /* @__PURE__ */ _jsxQ("span", null, null, formatMonth(props, state), 1, null),
      /* @__PURE__ */ _jsxQ("button", {
        onClick$: /* @__PURE__ */ inlinedQrl((event) => {
          const [props2, state2] = useLexicalScope();
          return changeMonth(props2, state2, 1);
        }, "Calendar_component_div_div_button_onClick_1_OxbGc1tFXYA", [
          props,
          state
        ])
      }, {
    ...
    /* @__PURE__ */ _jsxQ("div", null, {
      ...
      (getEmptyCells(props, state) || []).map((_, i) => {
        return /* @__PURE__ */ _jsxQ("div", null, null, null, 3, `empty-${i}`);
      }),
      (getDayCells(props, state) || []).map((_, i) => {
        return /* @__PURE__ */ _jsxQ("div", {
          class: `calendar-day ${isSelected(props, state, i + 1) ? "selected" : ""} ${isDisabled(props, state, i + 1) ? "disabled" : ""}`,
          onClick$: /* @__PURE__ */ inlinedQrl((event) => {
            const [i2, props2, state2] = useLexicalScope();
            return selectDate(props2, state2, i2 + 1);
          }, "Calendar_component_div_div_div_onClick_0r0NTqOnxcM", [
            i,
            props,
            state
          ])
...
}, "Calendar_component_PtPma4bv0Cc"));
const STYLES$1 = `
.calendar {
...
`;
const updateDateTime = function updateDateTime2(props, state) {
  props.onChange?.({
    target: {
...
const setDate = function setDate2(props, state, event) {
  state.selectedDateTime = new Date(event.target.value.getFullYear(), event.target.value.getMonth(), event.target.value.getDate(), state.selectedDateTime.getHours(), state.selectedDateTime.getMinutes());
  updateDateTime(props, state);
};
const setTime = function setTime2(props, state, event) {
  state.selectedDateTime = new Date(state.selectedDateTime.getFullYear(), state.selectedDateTime.getMonth(), state.selectedDateTime.getDate(), event.target.value.getHours(), event.target.value.getMinutes());
  updateDateTime(props, state);
};
const toggleCalendar = function toggleCalendar2(props, state) {
  state.isCalendarOpen = !state.isCalendarOpen;
};
const formatDate = function formatDate2(props, state) {
  return state.selectedDateTime.toLocaleDateString();
};
const DateTimePicker = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  _jsxBranch();
  useStylesScopedQrl(/* @__PURE__ */ inlinedQrl(STYLES, "DateTimePicker_component_useStylesScoped_8XKe06WrVaA"));
  const state = useStore({
    accentColor: props.accentColor || "#007bff",
    backgroundColor: props.backgroundColor || "#ffffff",
    borderStyle: props.showBorder ? `1px solid ${props.accentColor || "#007bff"}` : "none",
    ...
    selectedDateTime: props.value || /* @__PURE__ */ new Date(),
    textColor: props.textColor || "#333333"
  });
  return /* @__PURE__ */ _jsxQ("div", {
    style: {
    ...
    /* @__PURE__ */ _jsxQ("div", null, {
      ...
      /* @__PURE__ */ _jsxQ("span", null, null, formatDate(props, state), 1, null),
      /* @__PURE__ */ _jsxQ("button", {
        onClick$: /* @__PURE__ */ inlinedQrl((event) => {
          const [props2, state2] = useLexicalScope();
          return toggleCalendar(props2, state2);
        }, "DateTimePicker_component_div_div_button_onClick_8qN3cZOanrA", [
          props,
          state
        ])
      }, {
        class: "toggle-button"
      }, state.isCalendarOpen ? /* @__PURE__ */ _jsxC(Fragment, {
        children: "▲"
      }, 3, "qR_0") : /* @__PURE__ */ _jsxC(Fragment, {
        children: "▼"
      }, 3, "qR_1"), 0, null)
    ], 1, null),
    state.isCalendarOpen ? /* @__PURE__ */ _jsxC(Calendar, {
      get value() {
        return state.selectedDateTime;
      },
      onChange$: /* @__PURE__ */ inlinedQrl((event) => {
        const [props2, state2] = useLexicalScope();
        return setDate(props2, state2, event);
      }, "DateTimePicker_component_div_Calendar_onChange_gHFEqAmf5yk", [
        props,
        state
      ]),
      get minDate() {
      ...
      [_IMMUTABLE]: {
        accentColor: _fnSignal((p0) => p0.accentColor, [
          state
        ], "p0.accentColor"),
        backgroundColor: _fnSignal((p0) => p0.backgroundColor, [
          state
        ], "p0.backgroundColor"),
        fontSize: _fnSignal((p0) => p0.fontSize, [
          state
        ], "p0.fontSize"),
        maxDate: _fnSignal((p0) => p0.maxDate, [
          props
        ], "p0.maxDate"),
        minDate: _fnSignal((p0) => p0.minDate, [
          props
        ], "p0.minDate"),
        textColor: _fnSignal((p0) => p0.textColor, [
          state
        ], "p0.textColor"),
        value: _fnSignal((p0) => p0.selectedDateTime, [
          state
        ], "p0.selectedDateTime")
      }
    }, 2, "qR_2") : null,
    /* @__PURE__ */ _jsxC(TimePicker, {
      get value() {
        return state.selectedDateTime;
      },
      onChange$: /* @__PURE__ */ inlinedQrl((event) => {
        const [props2, state2] = useLexicalScope();
        return setTime(props2, state2, event);
      }, "DateTimePicker_component_div_TimePicker_onChange_rEyHYAbBBR8", [
        props,
        state
      ]),
      get format() {
      ...
      [_IMMUTABLE]: {
        ...
        format: _fnSignal((p0) => p0.format, [
          props
        ], "p0.format"),
        showBorder: _IMMUTABLE,
        size: _fnSignal((p0) => p0.size, [
          props
        ], "p0.size"),
        textColor: _fnSignal((p0) => p0.textColor, [
          state
...
}, "DateTimePicker_component_nW4KazC4TVM"));
const STYLES = `
.date-time-picker {
  font-family: "Roboto", sans-serif;
  width: 300px;
