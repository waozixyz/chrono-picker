import { componentQrl, inlinedQrl, useStylesScopedQrl, useStore, useTaskQrl, useLexicalScope, _jsxQ, _fnSignal, _jsxC, useVisibleTaskQrl } from "@builder.io/qwik";
...
const AutoComplete = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesScopedQrl(/* @__PURE__ */ inlinedQrl(STYLES$2, "AutoComplete_component_useStylesScoped_o3cUATH7B2E"));
  ...
  return /* @__PURE__ */ _jsxQ("div", null, {
    ...
    state.suggestions.length > 0 && state.showSuggestions ? /* @__PURE__ */ _jsxQ("ul", null, {
      ...
      return /* @__PURE__ */ _jsxQ("li", {
        ...
        item
      }, 3, "tU_0") : /* @__PURE__ */ _jsxQ("span", null, null, transform(props, state, item), 1, null), 0, idx);
    }), 1, "tU_1") : null
  ], 1, "tU_2");
...
const TodoApp = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  useStylesScopedQrl(/* @__PURE__ */ inlinedQrl(STYLES$1, "TodoApp_component_useStylesScoped_D323uXhI4Xg"));
  const state = useStore({
    list: [
      "hello",
      "world"
...
const TimePicker = /* @__PURE__ */ componentQrl(/* @__PURE__ */ inlinedQrl((props) => {
  ...
  return /* @__PURE__ */ _jsxQ("div", null, {
    class: _fnSignal((p0) => `time-picker ${p0.theme || "light"} ${p0.size || "medium"}`, [
      props
    ], '`time-picker ${p0.theme||"light"} ${p0.size||"medium"}`'),
    id: _fnSignal((p0) => p0.id, [
      state
    ], "p0.id"),
    style: _fnSignal((p0) => p0.customTheme, [
      props
    ], "p0.customTheme")
  }, /* @__PURE__ */ _jsxQ("div", null, {
    class: "time-display"
